...
import org.d3if0112.mobpro1.navigation.Screen
import org.d3if0112.mobpro1.ui.screen.MainViewModel
import org.d3if0112.mobpro1.ui.theme.Mobpro1Theme
import org.d3if0112.mobpro1.util.SettingDataStore
...
fun ListItem(karyawan: Karyawan, onClick:() -> Unit){
    Column(
        ...
        Text(text = karyawan.posisi,
            overflow = TextOverflow.Ellipsis,
            fontWeight = FontWeight.Bold)
        Text(text = karyawan.noKaryawan,
            maxLines = 2,
            overflow = TextOverflow.Ellipsis)
        Text(text = karyawan.name,
            maxLines = 1,
        )
    }
}
